                            ...
                            <div className="inner">
                                <ul className="widget_area">
                                    <li>
                                        <div className="item">
                                            <div className="logo">
                                                <Link href="/"><img src="/img/logo1-white.webp" alt="" /></Link>
                                            </div>
                                      <div className="textwidget">
                                            <p>
                                              At TorqTech, we are focused on delivering safety-driven and performance-focused outcomes,
                                              providing reliable oil & gas services through precision, technical expertise, and
                        ...
                        <div className="footer_bottom_in">
                            ...
                            <div className="footer_copyright">
                                <p>&copy; {(new Date().getFullYear())} Torqtech, All rights reserved. </p>
                                    {/* <Link href="https://themeforest.net/user/trendycoder" target="_blank" rel="noreferrer">TrendyCoder</Link> */}
                            </div>
